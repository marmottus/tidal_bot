...
#   filename:  model.yaml
#   timestamp: 2025-12-03T10:54:28+00:00
...
class ErrorObject(BaseModel):
    ...
    message: Annotated[
        str | None,
        Field(description="A short description of the cause of the error.\n"),
    ] = None
...
type Pitch = Annotated[float, Field(ge=0.0, le=1.0)]
...
class AudioFeaturesObject(BaseModel):
    ...
    type: Annotated[
        Literal["audio_features"] | None, Field(description="The object type.\n")
    ] = None
    uri: Annotated[
        str | None,
        Field(
...
class ImageObject(BaseModel):
    ...
    height: Annotated[
        int | None, Field(description="The image height in pixels.\n", examples=[300])
    ] = None
    width: Annotated[
        int | None, Field(description="The image width in pixels.\n", examples=[300])
    ] = None
...
class ArtistObject(BaseModel):
    ...
    followers: Annotated[
        ...
        Field(description="Information about the followers of the artist.\n"),
    ] = None
    genres: Annotated[
        list[str] | None,
        Field(
    ...
    type: Annotated[
        Literal["artist"] | None, Field(description="The object type.\n")
    ] = None
    uri: Annotated[
        str | None,
        Field(
...
class PrivateUserObject(BaseModel):
    ...
    followers: Annotated[
        FollowersObject | None,
        Field(description="Information about the followers of the user."),
    ] = None
    href: Annotated[
...
class PublicUserObject(BaseModel):
    ...
    followers: Annotated[
        FollowersObject | None,
        Field(description="Information about the followers of this user.\n"),
    ] = None
    href: Annotated[
        str | None, Field(description="A link to the Web API endpoint for this user.\n")
    ] = None
    ...
    type: Annotated[Literal["user"] | None, Field(description="The object type.\n")] = (
        None
    )
    uri: Annotated[
        str | None,
...
class SimplifiedTrackObject(BaseModel):
    ...
    preview_url: Annotated[
        str | None,
        Field(description="A URL to a 30 second preview (MP3 format) of the track.\n"),
    ] = None
...
class CategoryObject(BaseModel):
    ...
    icons: Annotated[
        list[ImageObject] | None,
        Field(description="The category icon, in various sizes.\n"),
    ] = None
    id: Annotated[
        str | None,
        Field(
    ...
    name: Annotated[
        str | None, Field(description="The name of the category.\n", examples=["EQUAL"])
    ] = None
...
class EpisodeBase(BaseModel):
    ...
    external_urls: Annotated[
        ExternalUrlObject | None, Field(description="External URLs for this episode.\n")
    ] = None
    href: Annotated[
        str | None,
        Field(
    ...
    type: Annotated[
        Literal["episode"] | None, Field(description="The object type.\n")
    ] = None
    uri: Annotated[
        str | None,
        Field(
...
class ShowBase(BaseModel):
    ...
    external_urls: Annotated[
        ExternalUrlObject | None, Field(description="External URLs for this show.\n")
    ] = None
    href: Annotated[
        str | None,
        Field(
    ...
    media_type: Annotated[
        str | None, Field(description="The media type of the show.\n")
    ] = None
    name: Annotated[str | None, Field(description="The name of the episode.\n")] = None
    publisher: Annotated[
        str | None, Field(description="The publisher of the show.\n")
    ] = None
    type: Annotated[Literal["show"] | None, Field(description="The object type.\n")] = (
        None
    )
    uri: Annotated[
        str | None,
    ...
    total_episodes: Annotated[
        int | None, Field(description="The total number of episodes in the show.\n")
    ] = None
...
class AudiobookBase(BaseModel):
    authors: Annotated[
        ...
        Field(description="The author(s) for the audiobook.\n"),
    ] = None
    available_markets: Annotated[
        list[str] | None,
        Field(
    ...
    external_urls: Annotated[
        ExternalUrlObject | None,
        Field(description="External URLs for this audiobook.\n"),
    ] = None
    href: Annotated[
        str | None,
        Field(
    ...
    media_type: Annotated[
        str | None, Field(description="The media type of the audiobook.\n")
    ] = None
    name: Annotated[str | None, Field(description="The name of the audiobook.\n")] = (
        None
    )
    narrators: Annotated[
        list[NarratorObject] | None,
        Field(description="The narrator(s) for the audiobook.\n"),
    ] = None
    publisher: Annotated[
        str | None, Field(description="The publisher of the audiobook.\n")
    ] = None
    type: Annotated[
        Literal["audiobook"] | None, Field(description="The object type.\n")
    ] = None
    uri: Annotated[
        str | None,
        Field(
    ...
    total_chapters: Annotated[
        int | None, Field(description="The number of chapters in this audiobook.\n")
    ] = None
...
class AlbumBase(BaseModel):
    ...
    total_tracks: Annotated[
        int | None,
        Field(description="The number of tracks in the album.", examples=[9]),
    ] = None
    available_markets: Annotated[
        list[str] | None,
        Field(
    ...
    external_urls: Annotated[
        ExternalUrlObject | None,
        Field(description="Known external URLs for this album.\n"),
    ] = None
    href: Annotated[
        str | None,
        Field(
    ...
    type: Annotated[
        Literal["album"] | None, Field(description="The object type.\n")
    ] = None
    uri: Annotated[
        str | None,
        Field(
...
class ChapterBase(BaseModel):
    ...
    chapter_number: Annotated[
        int | None, Field(description="The number of the chapter\n", examples=[1])
    ] = None
    description: Annotated[
        str | None,
        Field(
    ...
    external_urls: Annotated[
        ExternalUrlObject | None, Field(description="External URLs for this chapter.\n")
    ] = None
    href: Annotated[
        str | None,
        Field(
...
class AlbumObject(AlbumBase):
    ...
    tracks: Annotated[
        PagingSimplifiedTrackObject | None,
        Field(description="The tracks of the album.\n"),
    ] = None
    copyrights: Annotated[
        list[CopyrightObject] | None,
    ...
    external_ids: Annotated[
        ...
        Field(description="Known external IDs for the album.\n"),
    ] = None
    genres: Annotated[
        list[str] | None,
        Field(description="**Deprecated** The array is always empty.\n", examples=[[]]),
    ] = None
    label: Annotated[
        str | None, Field(description="The label associated with the album.\n")
    ] = None
    popularity: Annotated[
        int | None,
        Field(
...
class TrackObject(BaseModel):
    ...
    type: Annotated[
        Literal["track"] | None, Field(description='The object type: "track".\n')
    ] = None
    uri: Annotated[
        str | None,
        Field(
...
class ChapterObject(ChapterBase):
    audiobook: Annotated[
        SimplifiedAudiobookObject | None,
...
class CurrentlyPlayingObject(BaseModel):
    ...
    timestamp: Annotated[
        int | None,
        Field(description="Unix Millisecond Timestamp when data was fetched"),
    ] = None
    ...
    item: Annotated[
        ...
        Field(description="The currently playing track or episode. Can be `null`."),
    ] = None
...
class PlaylistTrackObject(BaseModel):
    ...
    track: Annotated[
        TrackObject | EpisodeObject | None,
        Field(description="Information about the track or episode."),
    ] = None
...
class QueueObject(BaseModel):
    ...
    queue: Annotated[
        list[TrackObject | EpisodeObject] | None,
...
class PlaylistObject(BaseModel):
    ...
    tracks: Annotated[
        ...
        Field(description="The tracks of the playlist.\n"),
    ] = None
    type: Annotated[str | None, Field(description='The object type: "playlist"\n')] = (
        None
    )
    ...
    followers: Annotated[
        FollowersObject | None,
        Field(description="Information about the followers of the playlist."),
    ] = None


class ShowObject(ShowBase):
    episodes: Annotated[
        PagingSimplifiedEpisodeObject | None,
        Field(description="The episodes of the show.\n"),
    ] = None


class AudiobookObject(AudiobookBase):
    chapters: Annotated[
        PagingSimplifiedChapterObject | None,
...
class SavedAudiobookObject(BaseModel):
    ...
    audiobook: Annotated[
        AudiobookObject | None, Field(description="Information about the audiobook.")
    ] = None
